                ...
                <div class="left full fondoblanco relative paddingtop15" id="content">
                    <table class="display fullimportant" id="tabla">
                        ...
                        <?php for($i = 0; $i < $calmacen; $i++){ ?>
                            <tr onclick="openPopupEdit(this, 450, 450)" data-postload="0" data-returnpage="pr-areas" data-form="" data-page="areas-edit" data-carpeta="ajax-edit" data-load="contenedor" data-valores="" data-id="<?php echo $almacen["id"][$i]; ?>">
                                <td><?php echo $almacen['nombre'][$i]; ?></td>
                            </tr>
                        <?php } ?>    
                        </tbody>    
                    </table>
